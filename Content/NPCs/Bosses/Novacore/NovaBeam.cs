...
{
    public class NovaBeam : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.npc[(int)Projectile.ai[1]].active && Main.npc[(int)Projectile.ai[1]].ModNPC is Novacore)
            {
        ...
        public static Color Nova => BaseUtility.MultiLerpColor(Main.LocalPlayer.miscCounter % 100 / 100f, Color.Purple, Color.HotPink);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture2D20 = ModContent.Request<Texture2D>("CSkies/Content/NPCs/Bosses/Novacore/NovaBeam2").Value;
            Texture2D texture2D21 = ModContent.Request<Texture2D>("CSkies/Content/NPCs/Bosses/Novacore/NovaBeam3").Value;

            Color color44 = Nova * 0.9f;

            if (Projectile.type == ModContent.ProjectileType<NovaBeamSmall>())
            {
                color44 = Color.Purple * 0.9f;
            }
        ...
        public override void CutTiles()
        {
            ...
            Utils.PlotTileLine(Projectile.Center, Projectile.Center + unit * Projectile.localAI[1], Projectile.width * Projectile.scale, DelegateMethods.CastLightOpen);
        }
    ...
    public class NovaBeamSmall : NovaBeam
    {
        public override string Texture => "CSkies/Content/NPCs/Bosses/Novacore/NovaBeam";
        ...
        public override void OnKill(int timeLeft)
        {
            if (Main.netMode != NetmodeID.MultiplayerClient)
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity, ModContent.ProjectileType<NovaBeam>(), Projectile.damage, Projectile.knockBack, Projectile.owner, Projectile.ai[0], Projectile.ai[1]);
