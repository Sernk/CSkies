...
namespace CSkies.Content.NPCs.Bosses.FurySoul
{
    public class Flameray : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture2D20 = ModContent.Request<Texture2D>("CSkies/Content/NPCs/Bosses/FurySoul/Flameray2").Value;
            Texture2D texture2D21 = ModContent.Request<Texture2D>("CSkies/Content/NPCs/Bosses/FurySoul/Flameray3").Value;
    ...
    {
        public override string Texture => "CSkies/Content/NPCs/Bosses/FurySoul/Flameray";
        ...
        public override void OnKill(int timeLeft)
        {
            if (Main.netMode != NetmodeID.MultiplayerClient)
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity, ModContent.ProjectileType<Flameray>(), Projectile.damage, Projectile.knockBack, Projectile.owner, Projectile.ai[0], Projectile.ai[1]);
